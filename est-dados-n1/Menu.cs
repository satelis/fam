...
namespace est_dados_n1 {
    internal class Menu {
        ...
        //inicia e loopa o menu
        public void StartaMenu() {
            Console.WriteLine("Bem vindo!");
            do {
                Console.WriteLine("\nPor favor, selecione uma opção:");
                Console.WriteLine("\n1- Imprimir lista por Região.\n2- Imprimir tabela com impostos.");
                Console.WriteLine("3- Imprimir lista por ano de fabricação\n4- Gerar relatório de frequência dos anos de fabricação");
                Console.WriteLine("\nSua opção: ");
                //converte o readline (string) pra int
                if (!Int32.TryParse(Console.ReadLine(), out escolha)) {
                    Console.Clear();
        ...
        private void primeiraOpcao() {
            do {
                Console.WriteLine("Escolha a região:");
